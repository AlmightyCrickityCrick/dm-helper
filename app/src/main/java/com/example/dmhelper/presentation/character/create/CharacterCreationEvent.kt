...
sealed class CharacterCreationEvent {
    ...
    data class HPChanged(val hp: String) : CharacterCreationEvent()
    data class LevelChanged(val level: String) : CharacterCreationEvent()
    data class EXPChanged(val exp: String) : CharacterCreationEvent()
    ...
    data class AbilityChanged(val type: AbilityType, val score: String) : CharacterCreationEvent()
